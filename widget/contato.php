<div class="main_contact py-5 bg-light text-center">
    <div class="container">
        ...
        <p class="mb-0">Quer conversar com um corretor exclusivo e ter um atendimento diferenciado em busca do seu imóvel dos sonhos?</p>
        <p>Preencha o formulário abaixo e vamos lhe direcionar para alguém que entenda a sua necessidade!</p>

        <div class="row text-left">
            <form action="">

                <div class="form-group d-flex">
                    <i class="icon-envelope text-black-50"></i>
                    <h2 class="text-black-50">Envie um e-mail</h2>
                </div>
                ...
                <div class="form-group">
                    <textarea name="teste" rows="5" placeholder="Escreva sua mensagem..." class="form-control"></textarea>
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12 col-md-4">
                ...
                <p class="pt-2"><a href="" class="text-front">cursos@upinside.com.br</a></p>
            </div>
            <div class="col-12 col-md-4">
                <h2 class="icon-phone">Por Telefone</h2>
                <p>Estamos disponíveis no número abaixo no horário comercial.</p>
                <p class="text-front pt-2">+55 (48) 3322-1234</p>
            </div>
