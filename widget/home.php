        ...
        <div class="row">
            <form action="" class="form-inline w-100">
                <div class="form-group col-12 col-sm-6 col-lg-3">
                    <label class="m-2" for="search"><b>Comprar ou Alugar?</b></label>
                ...
                <div class="col-6 mt-3 text-right">
                    <button class="btn btn-front icon-search">
                        Pesquisar
                    </button>
                </div>
            </form>
...
<section class="main_list_group bg-light py-5">
    <div class="container">
        <div class="border-bottom border-front p-4">
            <h1 class="text-center">Ambiente no <seuspan class="text-front"><b>estilo</b></seuspan>
            </h1>
        ...
        <div class="row">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    ...
                    <div class="card-body">
                        <h2><a href="#" class="text-front">Linda Casa no Rio Tavares com vista para o Mar</a></h2>
                        ...
                        <a href="#" class="btn btn-front">Ver Imóvel</a>
                    </div>
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="assets/images/properties/2/1cd48888-1311-4280-bcc3-39109c7d1875.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="#" class="text-front">Linda Casa no Rio Tavares com vista para o Mar</a></h2>
        ...
        <div class="row">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="assets/images/properties/4/3b9d6713-3e86-4d41-a21b-6b77fc414bf3.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="#" class="text-front">Linda Casa no Rio Tavares com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel residencial</p>
                        <p class="main_properties_item_type">Apartamento - Campeche <i class="icon-location-arrow"></i></p>
                        <p class="main_properties_item_price text-front">R$ 2.000,00</p>
                        <a href="#" class="btn btn-front">Ver Imóvel</a>
                    </div>
                    <div class="d-flex card-footer text-muted">
                        <div class="col-4 main_properties_item_features text-center">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="assets/images/properties/5/0ed8b84d-67c1-4688-86de-433ec3a498d5.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="#" class="text-front">Linda Casa no Rio Tavares com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel residencial</p>
                        <p class="main_properties_item_type">Apartamento - Campeche <i class="icon-location-arrow"></i></p>
                        <p class="main_properties_item_price text-front">R$ 1.800,00</p>
                        <a href="#" class="btn btn-front">Ver Imóvel</a>
                    </div>
                    <div class="d-flex card-footer text-muted">
                        <div class="col-4 main_properties_item_features text-center">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16by9">
                        <a href="">
                            <img src="assets/images/properties/5/536185a2-2625-4bb2-b548-063c5e0db63d.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="#" class="text-front">Linda Casa no Rio Tavares com vista para o Mar</a></h2>
                        <p class="main_properties_item_category">Imóvel residencial</p>
                        <p class="main_properties_item_type">Apartamento - Campeche <i class="icon-location-arrow"></i></p>
                        <p class="main_properties_item_price text-front">R$ 4.300,00</p>
                        <a href="#" class="btn btn-front">Ver Imóvel</a>
                    </div>
                    <div class="d-flex card-footer text-muted">
                        <div class="col-4 main_properties_item_features text-center">
